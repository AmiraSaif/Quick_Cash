package com.example.Amira201811086.activities;
...
import com.example.Amira201811086.R;
import com.example.Amira201811086.emplo.EmployerLandingPage;
import com.example.Amira201811086.job.Job;
import com.example.Amira201811086.location.GPSTracker;
...
public class SubmitActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        LocationMuscat = findViewById(R.id.location1);
    ...
    protected String getLocation(){
        return LocationMuscat.getText().toString().trim();
    }
    ...
    protected boolean validLocation(String location){
        return location.equalsIgnoreCase("Muscat");
    }
